...
"[project]/app/api/tenants/[tenantId]/admin/contact-submissions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        ...
        const canViewSubmissions = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["can"])(user, tenant, 'canManageContactSubmissions');
        ...
        const submissions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].contactSubmission.findMany({
            where: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(submissions);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e2fcecca._.js.map