...
const MessagesPage = ({ currentUser, initialConversations, onBack, onViewProfile, initialActiveConversationId })=>{
    ...
    const allUserConversations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MessagesPage.useMemo[allUserConversations]": ()=>conversations
    ...
    const [activeConversation, setActiveConversation] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "MessagesPage.useState": ()=>{
            if (initialActiveConversationId) {
                ...
                }["MessagesPage.useState"]) || conversations[0] || null;
            }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MessagesPage.useEffect": ()=>{
            ...
            if (conversationIdToSelect) {
                const conversationToActivate = conversations.find({
    ...
    const handleStartConversation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MessagesPage.useCallback[handleStartConversation]": async (recipientId)=>{
            ...
            if (response.ok) {
                ...
                setConversations({
                    "MessagesPage.useCallback[handleStartConversation]": (prev)=>{
                        const exists = prev.find({
                            "MessagesPage.useCallback[handleStartConversation].exists": (c)=>c.id === conversation.id
                        }["MessagesPage.useCallback[handleStartConversation].exists"]);
                        return exists ? prev : [
                            ...prev,
                            conversation
                        ];
    ...
    const forceConversationListUpdate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MessagesPage.useCallback[forceConversationListUpdate]": ()=>{
            ...
            fetch('/api/conversations').then({
                "MessagesPage.useCallback[forceConversationListUpdate]": (res)=>res.json()
            }["MessagesPage.useCallback[forceConversationListUpdate]"]).then({
                "MessagesPage.useCallback[forceConversationListUpdate]": (data)=>setConversations(data)
            }["MessagesPage.useCallback[forceConversationListUpdate]"]);
        }
    }["MessagesPage.useCallback[forceConversationListUpdate]"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/app/messages/MessagesPageClient.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(MessagesPageClient, "fN7XvhJ+p5oE6+Xlo0NJmXpxjC8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = MessagesPageClient;
var _c;
__turbopack_context__.k.register(_c, "MessagesPageClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_3d915d8f._.js.map