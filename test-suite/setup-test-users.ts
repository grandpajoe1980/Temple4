  ...
  try {
    ...
    console.log('✅ Created: superadmin@temple.com / SuperAdminPass123!');
      ...
      const visitorVisibilityPayload: Prisma.InputJsonObject = {
        ...
        talks: initialTenant.settings.visitorVisibility.talks,
        ...
        supportRequests: initialTenant.settings.visitorVisibility.supportRequests,
      };
      ...
      const permissionsPayload: Prisma.InputJsonObject = {
        MEMBER: {
          ...
          canCreateTalks: perms.MEMBER.canCreateSermons,
          ...
          canManageSupportRequests: perms.MEMBER.canManagePrayerWall,
        ...
        STAFF: {
          ...
          canCreateTalks: perms.STAFF.canCreateSermons,
          ...
          canManageSupportRequests: perms.STAFF.canManagePrayerWall,
        ...
        MODERATOR: {
          ...
          canCreateTalks: perms.MODERATOR.canCreateSermons,
          ...
          canManageSupportRequests: perms.MODERATOR.canManagePrayerWall,
        ...
        ADMIN: {
          ...
          canCreateTalks: perms.ADMIN.canCreateSermons,
          ...
          canManageSupportRequests: perms.ADMIN.canManagePrayerWall,
        ...
        data: {
          ...
          settings: {
            create: {
              ...
              enableTalks: initialTenant.settings.enableSermons,
              ...
              enableSupportRequests: initialTenant.settings.enablePrayerWall,
              autoApproveSupportRequests: initialTenant.settings.autoApprovePrayerWall,
